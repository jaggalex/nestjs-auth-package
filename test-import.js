// Тестовый скрипт для проверки локального импорта пакета
import { Auth, AuthGuard, AuthValidatorService, PermissionGuard, RequirePermissions, RequireRoles, RoleGuard, TokenExtractorService } from './dist/index.mjs';

console.log('✅ Успешный импорт пакета @yagas-cat/nestjs-auth');
